...
import { Settings as SettingsIcon, RefreshCw, Mic, Sun, Moon, Sparkles, Globe } from 'lucide-react';
      ...
      {open && (
        ...
        >
          ...
          <div className={'p-4 flex flex-col gap-4'}>
            ...
            <div className={'flex flex-col gap-2'}>
              ...
              <div className={'flex items-center gap-2'}>
                <select
                  ...
                  onChange={(e) =>
                    updateSettings({
                      pronunciationMode: (e.target.value as 'native' | 'romaji') || 'native',
                    })
                  }
                >
                  <option value="native">
            ...
            <div className={'flex flex-col gap-2'}>
              <label className={'text-xs font-medium text-muted-foreground'}>
                <Trans>AI message duration</Trans>
              </label>
              <div className={'flex items-center gap-2'}>
                <select
                  className={
                ...
                >
                  <option value="none">
                    <Trans>No time limit (default)</Trans>
                  </option>
                  <option value="5">
            ...
            <div className={'flex flex-col gap-2'}>
              ...
              <p className={'text-[10px] text-muted-foreground/60 leading-relaxed'}>
                <Trans>Auto-detected from browser. Your selection will be saved and remembered.</Trans>
              </p>
            </div>
