        ...
        <div className={'p-6 space-y-6'}>
          ...
          <section>
            <div className={'flex items-center justify-between mb-6'}>
              <div>
                <span className={'text-sm font-medium text-muted-foreground block mb-1'}>Overall Score</span>
            ...
            <div className={'space-y-2'}>
              ...
              <div>
                ...
                <div className={'relative'}>
                  ...
                  <motion.div
                    ...
                    style={{ left: `${getIndicatorPosition(scores.fluency)}%`, transform: 'translate(-50%, -50%)' }}
              ...
              <div>
                ...
                <div className={'relative'}>
                  ...
                  <motion.div
                    className={'absolute top-1/2 -translate-y-1/2 w-1 h-4 bg-slate-400 rounded-full'}
                    style={{ left: `${getIndicatorPosition(scores.accuracy)}%`, transform: 'translate(-50%, -50%)' }}
                    initial={{ opacity: 0, scale: 0 }}
                    animate={{ opacity: 1, scale: 1 }}
              ...
              <div>
                <div className={'flex items-center justify-between mb-1.5'}>
                  <span className={'text-xs text-muted-foreground'}>Comprehensibility</span>
                ...
                >
                  ...
                  >
                    {extractedInfo.length > 0 ? (
                      ...
                      <div className={'text-center py-6 text-xs text-muted-foreground'}>No information saved yet</div>
                    )}
                  </div>
                </motion.div>
              )}
                ...
                >
                  ...
                  >
                    {messages.length > 0 ? (
                      ...
                      <div className={'text-center py-4 text-sm text-muted-foreground'}>No messages</div>
                    )}
                  </div>
                </motion.div>
              )}
        ...
        <div className={'sticky bottom-0 bg-card/95 backdrop-blur-md border-t border-border/30 px-6 py-4'}>
          {waitlistSuccess ? (
            <div className={'text-center py-2'}>
              <p className={'text-sm text-emerald-500 font-medium'}>✓ Successfully saved! Redirecting...</p>
            </div>
          ) : (
