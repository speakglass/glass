...
export const FEEDBACK_EXPLANATIONS: Record<DemoLocale, Record<DemoLocale, string>> = {
  ...
  ja: {
    ...
    zh: '说具体时间时，要在时间后加 "に"。要说 "3時に"，不能说 "3時で"。',
  ...
  ko: {
    ...
    zh: '说具体时间时，要在时间后加 "에"。要说 "3시에"，不能只说 "3시"。',
  ...
  zh: {
    en: 'When talking about meeting times, add "见" or "见吧" at the end. Say "3点见" or "3点见吧".',
    ja: '待ち合わせの時刻を言うときは、最後に「见」または「见吧」を付けます。「3点见」または「3点见吧」と言います。',
    ko: '만나는 시간을 말할 때는 끝에 "见(지엔)" 또는 "见吧(지엔 바)"를 붙여요. "3点见" 또는 "3点见吧"라고 해야 해요.',
    zh: '说见面时间时，要在最后加 "见" 或 "见吧"。要说 "3点见" 或 "3点见吧"。',
    es: 'Al hablar de horas de encuentro, añade "见" o "见吧" al final. Di "3点见" o "3点见吧".',
    fr: 'Pour parler d\'heures de rendez-vous, ajoute "见" ou "见吧" à la fin. Dis "3点见" ou "3点见吧".',
  },
  es: {
    ...
    zh: '说具体时间时，要在时间前加 "a las"。要说 "a las 3pm"，不能只说 "3pm"。',
  ...
  fr: {
    ...
    zh: '说具体时间时，要在时间前加 "à"。要说 "à 15h"，不能只说 "15h"。',
...
export const FEEDBACK_SUMMARIES: Record<DemoLocale, Record<DemoLocale, string>> = {
  en: {
    ...
    zh: '做得很好！整个对话中，你表达得自信又清晰。我注意到你说了"Let\'s meet 3pm tomorrow then"。意思很明确，但在英语中，具体时间前需要加"at"。所以说"Let\'s meet at 3pm tomorrow then"会更自然。你的语气很友好，而且善用了"Great!"这样的口语表达，这对建立良好关系很有帮助。继续这样练习，你很快就能说得更自然了！✨',
  ...
  ja: {
    ...
    zh: '做得很好！整个对话中，你表达得自信又清晰。我注意到你说了"じゃあ明日3時で会おう"（那明天3点见吧）。意思很明确，但在日语中，约见面的时间需要用"に"。所以说"じゃあ明日3時に会おう"会更自然。你的语气很友好，而且善用了"いいね!"这样的口语表达，这对建立良好关系很有帮助。继续这样练习，你很快就能说得更自然了！✨',
  ...
  ko: {
    ...
    zh: '做得很好！整个对话中，你表达得自信又清晰。我注意到你说了"그럼 내일 3시 만나자"（那明天3点见吧）。意思很明确，但在韩语中，约见面的时间需要加"에"。所以说"그럼 내일 3시에 만나자"会更自然。你的语气很友好，而且善用了"좋아!"这样的口语表达，这对建立良好关系很有帮助。继续这样练习，你很快就能说得更自然了！✨',
  ...
  zh: {
    en: 'Great job! You communicated confidently and clearly throughout the conversation. I noticed you said "那明天3点见" (See you at 3 tomorrow). The message was clear and natural! In Chinese, adding "见" or "见吧" at the end makes it sound more complete. "那明天3点见吧" sounds even better. Your tone was friendly and you made good use of casual expressions like "太好了!" which really helps build rapport. Keep practicing this way, and you\'ll sound even more natural in no time! ✨',
    ja: '素晴らしいです！会話全体を通して、自信を持って明確にコミュニケーションを取れていました。「那明天3点见」（明日3時に会おう）と言いましたね。メッセージは伝わりました！中国語では最後に「见」または「见吧」を付けるとより完全な表現になります。「那明天3点见吧」と言うとさらに自然です。トーンは親しみやすく、「太好了!」のようなカジュアルな表現をうまく使っていて、良い関係を築くのに役立っています。このように練習を続ければ、すぐにもっと自然に聞こえるようになりますよ！✨',
    ko: '잘하셨어요! 대화 전체에서 자신감 있고 명확하게 의사소통을 하셨네요. "那明天3点见(나 밍티앤 산디엔 지엔)"이라고 말씀하셨는데, 메시지는 잘 전달되었어요! 중국어에서는 끝에 "见(지엔)" 또는 "见吧(지엔 바)"를 붙이면 더 완전한 표현이 돼요. "那明天3点见吧"라고 말하면 더욱 자연스러워요. 톤도 친근했고 "太好了!(타이하오러!)" 같은 캐주얼한 표현을 잘 활용하셨는데, 이게 친밀감을 형성하는 데 정말 도움이 돼요. 이런 식으로 계속 연습하면 곧 훨씬 자연스러운 중국어를 구사하실 수 있을 거예요! ✨',
    zh: '做得很好！整个对话中，你表达得自信又清晰。我注意到你说了"那明天3点见"。意思很明确！在中文里，最后加上"见"或"见吧"会显得更完整。说"那明天3点见吧"会更自然。你的语气很友好，而且善用了"太好了!"这样的口语表达，这对建立良好关系很有帮助。继续这样练习，你很快就能说得更自然了！✨',
    es: '¡Muy bien! Te comunicaste con confianza y claridad durante toda la conversación. Noté que dijiste "那明天3点见." El mensaje estaba claro. En chino, añadir "见" o "见吧" al final hace que suene más completo. Así que "那明天3点见吧" sería más natural. Tu tono fue amigable y usaste bien expresiones casuales como "太好了!" que realmente ayudan a crear conexión. ¡Sigue practicando así y sonarás aún más natural en poco tiempo! ✨',
    fr: 'Excellent travail ! Tu as communiqué avec confiance et clarté tout au long de la conversation. J\'ai remarqué que tu as dit "那明天3点见." Le message était clair. En chinois, ajouter "见" ou "见吧" à la fin rend l\'expression plus complète. Donc "那明天3点见吧" serait plus naturel. Ton ton était amical et tu as bien utilisé des expressions décontractées comme "太好了!" ce qui aide vraiment à créer du lien. Continue à pratiquer comme ça, et tu sonneras encore plus naturel très bientôt ! ✨',
  },
  es: {
    ...
    zh: '做得很好！整个对话中，你表达得自信又清晰。我注意到你说了"Nos vemos 3pm mañana entonces"。意思很明确，但在西班牙语中，具体时间前需要加"a las"。所以说"Nos vemos a las 3pm mañana entonces"会更自然。你的语气很友好，而且善用了"¡Genial!"这样的口语表达，这对建立良好关系很有帮助。继续这样练习，你很快就能说得更自然了！✨',
  ...
  fr: {
    ...
    zh: '做得很好！整个对话中，你表达得自信又清晰。我注意到你说了"On se voit 15h demain alors"。意思很明确，但在法语中，具体时间前需要加"à"。所以说"On se voit à 15h demain alors"会更自然。你的语气很友好，而且善用了"Super !"这样的口语表达，这对建立良好关系很有帮助。继续这样练习，你很快就能说得更自然了！✨',
...
export const FEEDBACK_TIPS: Record<DemoLocale, Record<DemoLocale, string>> = {
  ...
  ko: {
    ...
    zh: '记住：约会时间要加 "에" (3시에, 정오에, 한밤중에)。',
    es: 'Recuerda: Usa "에" con horas de encuentro (3시에, 정오에, 한밤중에).',
    fr: 'Rappel : Utilise "에" avec des heures de rendez-vous (3시에, 정오에, 한밤중에).',
  },
  zh: {
    en: 'Remember: Add "见" or "见吧" at the end for meeting times (3点见, 中午见, 午夜见).',
    ja: '覚えておきましょう：待ち合わせの時刻には最後に「见」または「见吧」を付けます（3点见、中午见、午夜见）。',
    ko: '기억하세요: 만나는 시간 끝에 "见" 또는 "见吧"를 붙여요 (3点见, 中午见, 午夜见).',
    zh: '记住：约会时间最后要加 "见" 或 "见吧" (3点见, 中午见, 午夜见)。',
    es: 'Recuerda: Añade "见" o "见吧" al final para horas de encuentro (3点见, 中午见, 午夜见).',
    fr: 'Rappel : Ajoute "见" ou "见吧" à la fin pour les heures de rendez-vous (3点见, 中午见, 午夜见).',
  },
  es: {
    ...
    zh: '记住：具体时间要用 "a las" (a las 3pm, a las 12, a la medianoche)。',
  ...
  fr: {
    ...
    zh: '记住：具体时间要用 "à" (à 15h, à midi, à minuit)。',
...
export const FEEDBACK_ITEMS: Record<DemoLocale, Record<DemoLocale, string>> = {
  ...
  ko: {
    ...
    zh: '在时间后加 "에"："3시에 만나자"（不是 "3시 만나자"）。',
    es: 'Añade "에" después de la hora: "3시에 만나자" (no "3시 만나자").',
    fr: 'Ajoute "에" après l\'heure : "3시에 만나자" (pas "3시 만나자").',
  },
  zh: {
    en: 'Add "见吧" at the end: "明天3点见吧" (not just "明天3点见").',
    ja: '最後に「见吧」を付けましょう：「明天3点见吧」（「明天3点见」だけではありません）。',
    ko: '끝에 "见吧"를 넣으세요: "明天3点见吧(밍티앤 산디엔 지엔 바)" ("明天3点见(밍티앤 산디엔 지엔)"만이 아니에요).',
    zh: '最后加 "见吧"："明天3点见吧"（不只是 "明天3点见"）。',
    es: 'Añade "见吧" al final: "明天3点见吧" (no solo "明天3点见").',
    fr: 'Ajoute "见吧" à la fin : "明天3点见吧" (pas juste "明天3点见").',
  },
  es: {
    ...
    zh: '在时间前加 "a las"："Nos vemos a las 3pm"（不是 "Nos vemos 3pm"）。',
  ...
  fr: {
    ...
    zh: '在时间前加 "à"："On se voit à 15h"（不是 "On se voit 15h"）。',
