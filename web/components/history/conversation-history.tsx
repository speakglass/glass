...
import type { ConversationDetail, ConversationSummary } from '@/lib/account-api';
import {
      ...
      <AlertDialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{selected?.title || 'this conversation'}"? This action cannot be undone
              and will permanently remove this conversation from your history.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
