                ...
                embeds=[
                    {
                        ...
                        "color": 0x6366F1,
                        "fields": [
                            {"name": "Email", "value": new_user.email, "inline": False},
                            {"name": "Name", "value": new_user.name or "—", "inline": True},
                            {"name": "User #", "value": f"#{total_users:,}", "inline": True},
                        ],
                    }
                ],
...
async def get_onboarding_status(
    ...
    return OnboardingStatusResponse(
        ...
        completed_at=account_user.onboarding_completed_at.isoformat() if account_user.onboarding_completed_at else None,
    )
...
async def complete_onboarding(
    ...
    try:
        ...
        return CompleteOnboardingResponse(
            success=True,
            completed_at=(
                updated_user.onboarding_completed_at.isoformat() if updated_user.onboarding_completed_at else ""
            ),
        )
